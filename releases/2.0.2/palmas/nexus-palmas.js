(() => {
    ...
    function buildPayload(rows, fallbackHeaders, pendingCapture) {
        ...
        // V2.0.2: restaura a lógica estável da v1.9.
        // Semana Cobrança é o calendário autoritativo do relatório de Notas Perdidas.
        // Distribuição + 6 permanece apenas como informação de auditoria, pois em notas
        // remarcadas ele representa a cobrança original e não a semana atual da nota.
